...
import ec.edu.espe.chickenfarm.utils.JsonHandler;
...
public class ChickenFarmSystem {
    ...
    public static void main(String[] args) {
        allChickens = loadFromJson("chickens.json");
        List<String> menuOptions = Arrays.asList("Create new chicken", "Edit a chicken", "Delete a chicken", "Print saved chickens", "Save data to CSV", "Exit program");
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 5:
                    ...
                    MessageBox.printMessage("File saved as: " + SAVE_FILE_NAME);
                    clearConsole();
                    break;
                case 6:
    ...
    private static void saveAllChickens() {
        try {
            JsonHandler.writeToJson("chickens.json", allChickens);
        } catch (IOException e){}
    }

    private static  ArrayList<Chicken> loadFromJson(String fileName) {
        Type listType = new TypeToken<ArrayList<Chicken>>(){}.getType();
        ArrayList<Chicken> data = new ArrayList<>();;
        try {
            data = JsonHandler.readFromJson("chickens.json", listType);
        } catch (IOException e) {}
        return data;
    }
