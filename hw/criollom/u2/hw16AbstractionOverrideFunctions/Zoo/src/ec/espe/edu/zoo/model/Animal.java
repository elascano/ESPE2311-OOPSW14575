...
public abstract class Animal {
    ...
    public void assingCage(int id){
        System.out.println("cage id new --->"+id);
        cageId=id;
    }
    
    public abstract void breathe();
    
   public void registerMetamorphose(boolean confirmation, String name){
       if (confirmation){
           System.out.println("The "+name+" animal is in metamorphosis");
       }else{
           System.out.println("The "+name+" animal is not  in metamorphosis");
       }
   }
}
