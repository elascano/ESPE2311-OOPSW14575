...
import ec.edu.espe.mazegen.utils.Utils;
...
public class Maze {
    ...
    public String generateAsciiMaze() {
        ...
        int[] randomStartRoomPos = Utils.getRandomOuterElement(width, height);
        int[] randomFinishRoomPos = randomStartRoomPos;
        while (randomFinishRoomPos == randomStartRoomPos) {
            randomFinishRoomPos = Utils.getRandomOuterElement(width, height);
        }
