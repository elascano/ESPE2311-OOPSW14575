...
public class FrmContact extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmbContact.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Edison Lascano", "Mateo Garcia", "Olivier Panis", "Allan Turing", "Gustavo Cerati" }));

        cmbxTyoe.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Family", "Friend", "Partner", "Classmate", "Professional", "Lover", "Soccer" }));
        ...
        lstHobbies.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Playing soccer", "reading", "listening to music", "Playing music", "Watching movies" };
        ...
        pnlBodyLayout.setHorizontalGroup(
            ...
            .addGroup(pnlBodyLayout.createSequentialGroup()
                ...
                .addGroup(pnlBodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(ftfBirthdate, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(pnlBodyLayout.createSequentialGroup()
                        .addGap(6, 6, 6)
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        ArrayList<String> hobbiesTodo = new ArrayList<>();
        hobbiesTodo.add("jugar");
        contactThatIntroduce = new Contact(12, "Yepez", "Jefferson", "0963122042",null, "Family", new Date(), hobbiesTodo, 'm', "none", 100);
        type = cmbxTyoe.getSelectedItem().toString();
        birthDay = new Date();
        gender = 'M';
        comments = txtaComments.getText().toString();
        yearsOfFriendship = sldYearsOfFriendship.getValue();
        
        myContact = new Contact(id, lastName, firstName, cellPhoneNumber, contactThatIntroduce, type, birthDay, hobbies, gender, comments, yearsOfFriendship);
        ...
        JOptionPane.showConfirmDialog(btnAdd, info);
        
        
        ContactController.register(myContact);
