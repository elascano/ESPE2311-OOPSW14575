...
public class Contact {
    ...
    public Contact(int id, String lastName, String firstName, String cellPhoneNumber, Contact contactThatIntroduce, String type, Date birthDay, ArrayList<String> hobbies, char gender, String comments, int yearsOfFriendship) {
        this.id = id;
