...
public static void saveChickensToJSON(List<Chicken> chickens) {
    try (BufferedWriter writer = new BufferedWriter(new FileWriter("chickens.json"))) {
        writer.write("[\n");
