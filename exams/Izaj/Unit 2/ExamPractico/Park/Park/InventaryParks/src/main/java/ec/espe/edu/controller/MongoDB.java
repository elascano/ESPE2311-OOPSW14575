...
public class MongoDB {
    ...
    public static void insert() {
        ...
        boolean isAvailable;
        String name;
        String url = "mongodb+srv://mateo:mateo@cluster0.yftrjpg.mongodb.ne";
        try(MongoClient mongoClient = MongoClients.create(url))
        {
            MongoDatabase database = mongoClient.getDatabase("Park");
            try
            {
    ...
    public static void update() {
        ...
        boolean isAvailable;
        String name;
        String url = "mongodb+srv://mateo:mateo@cluster0.yftrjpg.mongodb.net/";
        ...
        try(MongoClient mongoClient = MongoClients.create(url))
        {
            ...
            {
                System.out.println("Connected to the database.");               
                MongoCollection collection = database.getCollection("Parks");               
