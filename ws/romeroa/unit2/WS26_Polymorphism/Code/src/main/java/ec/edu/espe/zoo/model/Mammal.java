...
public class Mammal extends Vertebrate {
    ...
    public Mammal(int numberOfdMammaryGlands, String spine, int numberOfBones, int id, String scientificName,
    ...
    public void breastFeed() {
        System.out.println("    The mammal is breastfeeding the baby");
    }
