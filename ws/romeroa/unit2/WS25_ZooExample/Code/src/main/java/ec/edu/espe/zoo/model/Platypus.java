...
public class Platypus extends Mammal {
    ...
    public Platypus(boolean poisoness, int poisonGlands, int numberOfdMammaryGlands, String spine, int numberOfBones,
            int id, String scientificName, Date bornDate, int cageId) {
