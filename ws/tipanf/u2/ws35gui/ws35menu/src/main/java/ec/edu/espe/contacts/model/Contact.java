...
public class Contact {
    ...
    public Contact(int id, String lastName, String firstName, String cellPhoneNumber, String contactThatIntroduce, String typeOfContact, Date birthDate, ArrayList<String> hobbies, char gender, String comments, int yearsOfFriendship) {
        this.id = id;
    ...
    public Contact(){
        ...
        lastName = "las";
        firstName = "edi";
        cellPhoneNumber = "0987071735";
        contactThatIntroduce = "Samantha";
        typeOfContact = "Familty";
        birthDate = new Date();
