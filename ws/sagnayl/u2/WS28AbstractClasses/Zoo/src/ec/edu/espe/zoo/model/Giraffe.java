...
public class Giraffe extends Mammal{
    ...
    public Giraffe(int numberOfMammaryGland, String sping, int numberOfBones, int id, String scientificName, Date bornDate, int cageId) {
    ...
    @Override
    public void feed() {
        System.out.println("feeding giraffe whith grass");
    }
