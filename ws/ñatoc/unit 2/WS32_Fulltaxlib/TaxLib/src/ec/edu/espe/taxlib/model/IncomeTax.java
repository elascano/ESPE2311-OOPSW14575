...
public class IncomeTax {
   ...
   public static double baseTaxes(double income) {
        ...
        total = taxBaseCalculation(income);
        System.out.println("TAX BASE TOTAL:" + total);
        totalBasic = basicFraction(total);
        System.out.println(totalBasic);
        icomeTaxCaused = icomeTaxCaused(totalBasic);
    ...
    public static double basicFraction(double total) {
        ...
        double basicFraccionPercentage ;
        double ImpBasicFraction ;
        double taxCaused = 0;
