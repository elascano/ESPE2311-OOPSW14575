...
public class Contacts {
    ...
    public static void main(String[] args) { 
        ...
        person.setName("Changed Name"); // Cambio el nombre de la persona
        System.out.println("Person before ---> " + person);
        
        registerContact(id, name, phoneNumber, email, person); // Corrijo la llamada al método y los parámetros       
