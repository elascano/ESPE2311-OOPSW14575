 ...
 * @author RC_558
 */
public class FromContacts extends javax.swing.JFrame {

    /**
     * Creates new form FromContacts
     */
    public FromContacts() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Male", "FemMale", "Others" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FromContacts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FromContacts().setVisible(true);
            }
        });
    }
